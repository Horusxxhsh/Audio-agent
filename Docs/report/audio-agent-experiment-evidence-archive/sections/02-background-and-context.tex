...
现有论文材料已经对主张进行了收敛。提交面文稿将主贡献限定为 retrieval-grounded editable preset control，并把 real-audio robustness 与端到端插件输出质量降级为探索或后续工作。本报告延续这一保守方向，并进一步将证据层分为 source claim、repo-observed fact、design intent 和 report synthesis。凡是只存在于计划、脚本或缺失输出报告中的内容，都不能被写成已经验证的事实。
